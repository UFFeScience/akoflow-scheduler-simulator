...
SLA definido por ambiente: budget com margem `0.95x` e deadline com margem `0.95x` sobre a média do HEFT usado como baseline. Cada combinação possui 1 sementes pareadas.
...
Barras empilhadas com a parcela média das 6543 atividades destinada às famílias Bora, Diablo, H3 e H4D.
