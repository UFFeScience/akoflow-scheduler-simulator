...
SLA definido por ambiente: budget com margem `1.2x` e deadline com margem `1.2x` sobre a média do HEFT usado como baseline. Cada combinação possui 1 sementes pareadas.
