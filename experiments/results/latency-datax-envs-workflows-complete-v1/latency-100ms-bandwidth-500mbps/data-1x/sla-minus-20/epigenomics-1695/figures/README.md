...
SLA definido por ambiente: budget com margem `0.8x` e deadline com margem `0.8x` sobre a média do HEFT usado como baseline. Cada combinação possui 1 sementes pareadas.
