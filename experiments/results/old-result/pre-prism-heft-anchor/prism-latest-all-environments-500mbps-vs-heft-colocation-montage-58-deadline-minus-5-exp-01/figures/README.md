...
SLA definido por ambiente: budget com margem `1.2x` e deadline com margem `0.95x` sobre a média do HEFT usado como baseline. Cada combinação possui 30 sementes pareadas.
